...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', default='data\\images\\train', type=str, help='Images path.')
    parser.add_argument('--ground_path', default='data\\ground_truth\\train', type=str, help='Ground truth path.')
